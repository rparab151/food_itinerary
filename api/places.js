...
//   - openNow (optional, "1" or "0"; when "1", adds `opennow=true`)
//   - keyword (optional; free-text keyword like "south indian", "udupi", "malvani", etc.)
//   - type (optional, default "restaurant")
//
// Requires env var: GOOGLE_MAPS_API_KEY (server key; NOT referrer-restricted)
  ...
  try {
    ...
    const results = (data.results || [])
      ...
      .map((r) => ({
        ...
        types: r.types || [],
        isOpenNow: r.opening_hours?.open_now, // boolean | undefined
      }));
